...
export default function OfficialProvidersListPage() {
  ...
  const fetchProviders = async (categoryId = '', isPartner = false) => {
    try {
      let url = '/public/official-providers';
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    <Link
                      to={`/prestataires-officiels/${provider.id}`}
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        className="flex-1 bg-gradient-to-r from-orange-600 to-red-600 text-white p-2.5 rounded-xl hover:from-orange-700 hover:to-red-700 transition-all shadow-lg flex items-center justify-center"
                      >
                      ...
                      <a
                        ...
                        className="flex-1 bg-gradient-to-r from-green-600 to-green-700 text-white p-2.5 rounded-xl hover:from-green-700 hover:to-green-800 transition-all shadow-lg flex items-center justify-center"
                      >
