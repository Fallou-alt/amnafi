...
export default function ProviderRegisterPage() {
  ...
  const initiatePayment = async () => {
    setLoading(true);
    try {
      const response = await api.post('/premium/initiate', {
              ...
              <div className="flex items-start gap-4">
                ...
                <label htmlFor="age_confirmed" className="flex-1 cursor-pointer">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    En cochant cette case, je confirme sur l'honneur être majeur(e) et avoir la capacité juridique d'utiliser la plateforme AMNAFI.
                  </p>
                </label>
              </div>
            </div>
