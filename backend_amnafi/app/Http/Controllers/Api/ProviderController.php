    ...
    public function index(Request $request)
    {
        ...
        $providers->getCollection()->transform(function ($provider) {
            ...
            $provider->profile_photo_url = $provider->profile_photo ? 
                'https://amnafi.net/backend/public/storage/' . $provider->profile_photo : null;
            $provider->cover_photo_url = $provider->cover_photo ? 
                'https://amnafi.net/backend/public/storage/' . $provider->cover_photo : null;
        ...
        $services->transform(function ($service) {
            if ($service->provider) {
                $service->provider->profile_photo_url = $service->provider->profile_photo ? 
                    'https://amnafi.net/backend/public/storage/' . $service->provider->profile_photo : null;
