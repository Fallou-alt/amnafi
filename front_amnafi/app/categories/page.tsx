...
import { ArrowLeft, Search, Star, MapPin, Phone, MessageCircle, Crown, CheckCircle } from 'lucide-react';
...
export default function CategoryPage() {
  ...
  const fetchProviders = async (catId: string) => {
    try {
      setLoading(true);
      const url = `http://localhost:8000/api/public/providers/by-category/${catId}`;
      ...
      <div className="bg-white/80 backdrop-blur-sm shadow-lg border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-4 mb-6">
            <Link href="/services" className="flex items-center text-blue-600 hover:text-blue-700">
